...
class TestJointEnslavement:
    def test_joint_enslavement(self, dcm, mem, zero_pos, test_objects_dico, test_time, test_limit):
    ...
    def test_leg_enslavement(self, dcm, mem, zero_pos, test_leg_dico, test_time, test_limit):
        """
    ...
    def test_wheels_enslavement(self, dcm, mem, zero_pos, test_wheels_dico, stiff_robot_wheels, test_time, test_wheels_limit):
        """
