...
class Log(threading.Thread):
    ...
    def __init__(self, dcm, mem, event, limit_position,
                 limit_speed, file_name):
        """
        @dcm                    : proxy to DCM (object)
        ...
        self._dico = {
            ...
            "HeadPitch": JointDico(dcm, mem, "HeadPitch"),
            "HeadYaw": JointDico(dcm, mem, "HeadYaw"),
            "HipPitch": JointDico(dcm, mem, "HipPitch"),
            "HipRoll": JointDico(dcm, mem, "HipRoll"),
            "KneePitch": JointDico(dcm, mem, "KneePitch")
        }
